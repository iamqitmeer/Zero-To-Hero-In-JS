...
addProduct.addEventListener("click", () => {
  ...
  if (productData.productImage) {
    let productImageRef = ref(
      storage,
      "images/" + productData.productImage.name
    ); // Specify a non-root reference

    uploadBytes(productImageRef, productData.productImage)
      .then(() => {
        ...
        getDownloadURL(productImageRef).then((url) => {
          ...
          addProduct.innerText = "Save Product";
          });
